                            ...
                            <form className="col-md-11" onSubmit={this.handleSubmit}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="exampleFormName"
                                           placeholder="Įveskite darbuotojo vardą" name="firstname" value={this.state.firstname}
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="exampleFormSurname"
                                           placeholder="Įveskite darbuotojo pavardę" name="lastname" value={this.state.lastname}
                                           onChange={this.handleChangeInput}/>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="exampleFormControlInput1">Username</label>
                                    <input type="text" className="form-control" id="exampleFormUsername"
                                           placeholder="Įveskite vartotojo prisijungimo vardą" name="username" value={this.state.username}
                                           onChange={this.handleChangeInput}/>
                                </div>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="exampleFormIdentifier"
                                           placeholder="Įveskite vartotojo identifikatorių" name="userIdentifier" value={this.state.userIdentifier}
                                           onChange={this.handleChangeInput}/>
                                </div>
                                ...
                                <input type="password" id="inputPassword5" className="form-control" value={this.state.password}
                                       aria-describedby="passwordHelpBlock" onChange={this.handleChangeInput} name="password"/>
                                <small id="passwordHelpBlock" className="form-text text-muted">
